<template>
  <el-breadcrumb class="app-breadcrumb" separator="→" style="height:50px;backgroundColor:rgb(64,158,255);borderRadius:1px;padding:0px 20px 0px 20px;boxShadow:0px 0px 8px #aaaaaa;borderWidth:4px;borderStyle:;borderColor:#ff0000;">
