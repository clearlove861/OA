<template>
    <div style="backgroundImage: url('https://w.wallhaven.cc/full/q2/wallhaven-q2ew3l.jpg');background-size:cover;">
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(12,0,0,0.52);borderRadius:22px">
                <h1 class="h1" style="color:#ffffff;fontSize:28px;">CRM企业客户关系管理系统注册</h1>
